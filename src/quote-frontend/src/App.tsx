          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            {result && (
              <div className="mt-6 p-4 bg-gray-700 rounded text-center">
                <p className="text-lg">Estimated Cost: <span className="font-semibold">${result.cost.toFixed(2)}</span></p>
                <p className="text-lg">Estimated Time: <span className="font-semibold">{result.time}</span></p>
              </div>
            )}
          </div>
        </div>
